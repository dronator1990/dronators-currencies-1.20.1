...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.SILVER_ORE, copperLikeOreDrops(ModBlocks.SILVER_ORE, ModItems.RAW_SILVER));
        addDrop(ModBlocks.DEEPSLATE_SILVER_ORE, copperLikeOreDrops(ModBlocks.SILVER_ORE, ModItems.RAW_SILVER));
    }
